...
function showPB(nSteps)
{
	...
	.hide{position:fixed; cursor:pointer; top:27px; left:2px !important; border-style:solid; border-width:2px; width: 125px; height: 40px; font-size:15px; text-align:center;}";
